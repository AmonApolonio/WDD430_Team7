...
import { InventoryTabSkeleton } from '@/components/ui/Skeletons';
...
function InventoryTabContent({
  ...
  setModalMode: React.Dispatch<React.SetStateAction<'view' | 'edit' | 'add'>>;
  modalItemId: string | undefined;
  setModalItemId: React.Dispatch<React.SetStateAction<string | undefined>>;
  ...
  }, [search, pageIndex, pageSize, categoryFilter, statusFilter]);
